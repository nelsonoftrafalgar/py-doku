...
test('getSectorItemCoords should return coords in sector board ', () => {
...
test('getSectorById should return sector containing given number', () => {
...
test('getSectorIndex should return index of sector containing given number', () => {
